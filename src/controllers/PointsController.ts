...
class PointsController{
    ...
    async create(request: Request, response: Response){
        ...
        //trx é uma sigla para transaction
    
        const trx = await knex.transaction();

            const point= {
                image:'https://images.unsplash.com/photo-1579966434689-366396b4963c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=723&q=80',
                name,
                email,
                whatsapp,
                latitude,
